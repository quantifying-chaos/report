This chapter aims to remedy the loose and unrigorous use of the term chaos so far in this report by giving precise definitions and proofs for important theorems using tools in topology and analysis.
